...
:::smallest
``` {.r filename="_common.R" code-line-numbers="15"}
status <- function(type) {
  ...
...
## Keeping things in check with GitHub actions

#[](images/r4ds-action-fail-email.png)
...
> Whenever faced with a problem, some people say "Lets use regular expressions."
...
> Whenever faced with a problem, some people say "Lets use ~~regular expressions~~[GitHub actions]{.red}."
...
::: {.column width="50%" .fragment fragment-index=1}
::: {.center-align .medium}
![](images/r4ds-render-deploy-action.png){fig-align="center"}
:::
:::
::: {.column width="50%" .fragment fragment-index=2}
::: {.center-align .medium}
![](images/quarto-actions.png){fig-align="center"}
:::
:::
:::
